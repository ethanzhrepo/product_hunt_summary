...
class GeminiAnalyzer(AIAnalyzer):
    """Google Gemini API analyzer for product content analysis and summary generation"""
    
    def __init__(self, api_key: str, model: str = "gemini-1.5-flash", language: str = "zh"):
        """
